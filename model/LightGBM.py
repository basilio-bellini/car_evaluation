...
def objective_lgbm(trial):
    ...
    for train_idx, val_idx in kf.split(X_train):
        ...
        model_lgbm.fit(x_tr, y_tr,  categorical_feature=categorical)
...
best_model_lgbm = LGBMRegressor(**study_lgbm.best_params, random_state=42)
best_model_lgbm.fit(X_train, y_train, categorical_feature=categorical)
